...
if(isset($_POST['security_submit'])){
    ...
    $sql="SELECT * FROM security WHERE email ='$email' AND password = '$password'";
    ...
    if(mysqli_num_rows($result)==1){
        ...
        session_start();
        $_SESSION["security_email"] = $row["email"];
        $_SESSION["name"] = $row["name"];
        $_SESSION["loggedin"] = true;
        header("location: /hostel/security/securityDashboard.php");
    } else {
...
<body>
  ...
  <div class="login-card">
    ...
    <form method="post">
      ...
      <button type="submit" name="security_submit" class="btn-login">Login</button>
